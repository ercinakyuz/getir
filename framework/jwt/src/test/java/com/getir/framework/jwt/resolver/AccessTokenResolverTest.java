...
public class AccessTokenResolverTest extends AbstractJwtTest {
    ...
    public void beforeEach() {
        accessTokenResolver = new AccessTokenResolver(jwtParser);
    }
    ...
    public void should_resolve() {
        ...
        final Jws<Claims> jwsClaims = jwtFaker.accessTokenJwsClaims();
        ...
        final GetirJwtClaims getirJwtClaims = accessTokenResolver.resolve(accessToken);
